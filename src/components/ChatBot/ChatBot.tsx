      ...
      <div className={`${styles.panel} ${isOpen ? styles.panelOpen : ""}`}>
        <div className={styles.header}>
          ...
          <div className={styles.headerBtns}>
            <button className={styles.hBtn} onClick={resetChat} title="New chat">
        ...
        <div className={styles.messages}>
          {messages.map((msg, i) => (
            <div key={i} className={`${styles.msgGroup} ${msg.role === "user" ? styles.userGroup : styles.botGroup}`}>
              {msg.role === "assistant" && <span className={styles.roleTag}>AI COACH</span>}
        ...
        <div className={styles.inputArea}>
          <div className={styles.inputRow}>
            <textarea
              ...
              disabled={loading}
            />
            <button className={styles.sendBtn} onClick={() => sendMessage()} disabled={!input.trim() || loading} aria-label="Send">
